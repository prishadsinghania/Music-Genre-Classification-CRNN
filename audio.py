...
#from tensorflow.python.keras.layers import Input, Flatten, BatchNormalization, Dense, Conv2D, MaxPooling2D, Dropout, Embedding, MultiHeadAttention, GlobalAveragePooling1D, Reshape, SimpleRNN
#from tensorflow.python.keras.callbacks import EarlyStopping, ModelCheckpoint, TensorBoard
#from tensorflow.python.keras.models import Model, Sequential
#from tensorflow.python.keras.regularizers import l2

from tensorflow.keras.layers import Input, Flatten, BatchNormalization, Dense, Conv2D, MaxPooling2D, Dropout, Embedding, GlobalAveragePooling1D, Reshape, SimpleRNN, MultiHeadAttention
...
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Flatten, Dense, Permute, GRU
